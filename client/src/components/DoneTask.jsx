...
function DoneTask({ status, count, title, desc }) {
  ...
  const onDoingClicked = async (id) => {
    await fetch(`https://kanban-task-server.onrender.com/update-to-doing/${id}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
      })
    ...
    >
      ...
      <Box>
        ...
        >
          ...
          <MenuItem onClick={() => onDoingClicked(count)}>Doing</MenuItem>
